<div class="tab-info">
    <label class="control-label" style="width: 100%;">
        <b>BluePay Settings</b>
            <hr style="width:100%;" />
        </label>
    <div class="form-group">
        <label for="settings[bluepay_account_id]" class="control-label">
            <?php echo lang('bluepay_account_id'); ?>
        </label>
        <input type="text" name="settings[bluepay_account_id]" class="input-sm form-control"
               value="<?php echo $this->mdl_settings->setting('bluepay_account_id'); ?>">
    </div>
    <div class="form-group">
        <label for="settings[secret_key]" class="control-label">
            <?php echo lang('secret_key'); ?>
        </label>
        <input type="text" name="settings[secret_key]" class="input-sm form-control"
               value="<?php echo $this->mdl_settings->setting('secret_key'); ?>">
    </div>
    <div class="form-group">
        <label for="settings[mode]" class="control-label">
            <?php echo lang('bluepay_mode'); ?>
        </label>
        <select name="settings[mode]" class="input-sm form-control">
            <option value="TEST" <?php if($this->mdl_settings->setting('mode') == "TEST") { echo "selected"; } ?>>TEST</option>
            <option value="LIVE" <?php if($this->mdl_settings->setting('mode') == "LIVE") { echo "selected"; } ?>>LIVE</option>
        </select>
    </div>
    
    <label class="control-label" style="width: 100%;">
        <b>Merchant Settings</b>
            <hr style="width:100%;" />
        </label>
