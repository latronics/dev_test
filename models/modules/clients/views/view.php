...
<div id="headerbar">
    ...
    <div class="pull-right btn-group">
        <a href="#" class="btn btn-sm btn-default client-create-quote"
           data-client-name="<?php echo $client->client_id; ?>">
...
<ul id="settings-tabs" class="nav nav-tabs nav-tabs-noborder">
    ...
    <li><a data-toggle="tab" href="#signed_tickets"><?php echo lang('signed_tickets'); ?></a></li>
</ul>
...
<div class="tabbable tabs-below">
    ...
    <div class="tab-content">
        ...
        <div id="signed_tickets" class="tab-pane table-content">
            <?php $this->load->view('clients/show_signed_tickets'); ?>
        </div>
