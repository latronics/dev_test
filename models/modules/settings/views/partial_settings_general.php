...
<div class="tab-info">
            ...
            <div class="form-group">
                ...
                <select name="settings[default_list_limit]" class="input-sm form-control"
                    ...
                    <option value="100"
                     ...
                     <option value="200"
                            <?php if ($this->mdl_settings->setting('default_list_limit') == '200') { ?>selected="selected"<?php } ?>>
                        200
                    </option>
                </select>
            </div>
    ...
    <div class="form-group">
        ...
        <label class="control-label">
            <?php echo lang('enable_debug_mode'); ?>
        </label>
    ...
    <h4><?php echo "Integration Settings"; ?></h4>
    <br/>
    ...
    <div class="form-group">
        ...
        <label  class="control-label">
            <?php echo "365LaptopRepair System?"; ?>
        </label>
        <select name="settings[365laptoprepair]" class="input-sm form-control"
                id="disable_sidebar">
            <option value="0" <?php if($this->mdl_settings->setting('365laptoprepair') == 0) { echo "selected"; } ?>>
                <?php echo lang('no'); ?>
            </option>
            <option value="1" <?php if($this->mdl_settings->setting('365laptoprepair') == 1) { echo "selected"; } ?>><?php echo lang('yes'); ?></option>
        </select>
    </div>
