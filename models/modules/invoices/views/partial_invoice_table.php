            ...
            <tr>
                <td>
                    <span class="label <?php echo $invoice_statuses[$invoice->invoice_status_id]['class']; ?>">
                        <?php if($invoice_statuses[$invoice->invoice_status_id]['label'] == "Draft") {echo "Estimates";} else if($invoice_statuses[$invoice->invoice_status_id]['label'] == "Viewed"){echo "Denied";}else {echo $invoice_statuses[$invoice->invoice_status_id]['label'];}
