...
<ul id="settings-tabs" class="nav nav-tabs nav-tabs-noborder">
    ...
    <li>
        <a data-toggle="tab" href="#settings-import"><?php echo lang('import_data_products_services'); ?></a>
    </li>
</ul>
...
<form method="post" id="form-settings" enctype="multipart/form-data">
    ...
    <div class="tabbable tabs-below">
        ...
        <div class="tab-content col-xs-12 col-md-10 col-lg-8">
            ...
            <div id="settings-import" class="tab-pane">
                <?php $this->layout->load_view('settings/csv_to_services'); ?>
            </div>
