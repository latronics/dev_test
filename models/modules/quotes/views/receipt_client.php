...
$get_quote_data = $this->db->get();
$quote_data = $get_quote_data->result_array();

$date = date("m-d-Y", strtotime($quote_data[0]['quote_date_created']));
?>
...
<table  cellpadding="2" cellspacing="2" border="0" style="font-size:13px;  font-family: Tahoma, Geneva, sans-serif;" align="center" >
    ...
    <tr style="padding:10px; text-align: center; background: #2093c4;"><td  colspan="2"><b>365 Laptop Repair - (STORE HERE) - Order: <?php  echo $quote_data[0]['quote_number']; ?></b></td></tr><br>
...
<div style="background:#EFEFEF; padding:5px;"><strong>Username:</strong> <?php  echo $quote_data[0]['client_email']; ?>&nbsp;&nbsp;/&nbsp;&nbsp;
<strong>Password:</strong> (YOUR PHONE NUMBER)</div>


</td></tr><tr>
    <td colspan="2"><strong>Customers Name:</strong> <?php  echo $quote_data[0]['client_name']; ?></td>
  </tr>
  <tr>
    <td width="50%"><strong>Phone Number:</strong> <?php  echo $quote_data[0]['client_phone']; ?></td>
    <td width="50%"><strong>Email:</strong> <?php  echo $quote_data[0]['client_email']; ?></td>
  </tr>
  
 
 
  <tr>
    <td colspan="2"><strong>Accessories included:</strong> <?php  echo $quote_data[0]['accessories_included']; ?></td>
  </tr>
  <tr>
    <td colspan="2"><strong>Data Recovery:</strong> <?php  if($quote_data[0]['data_recovery'] == 0){ echo "No"; } else { echo "Yes"; } ?></td>
  </tr>
  <tr>
  ...
  <tr>
    <td><strong>Computer Brand:</strong> <?php  echo $quote_data[0]['brand']; ?></td>
    <td><strong>Computer Model:</strong> <?php  echo $quote_data[0]['model']; ?></td>
  </tr>
  <tr>
    <td><strong>Serial Number:</strong> <?php  echo $quote_data[0]['serial_number']; ?></td>
      <td><strong>Cost:</strong> <?php  echo $quote_data[0]['amount']; ?></td>
    </tr>
    <tr>
    <td><strong>Problem Description:</strong> <?php echo $quote_data[0]['problem_description_product'];  ?></td>
  </tr>
  
  </table><br /><br />
 
 
  <table width="630" cellpadding="2" cellspacing="2" border="0" style="font-size:10px;  font-family: Tahoma, Geneva, sans-serif;" align="center">
  <tr>
  ...
  <tr>
    <td align="right"><strong>Date:</strong> <?php echo $date;  ?> / Order: <?php  echo $quote_data[0]['quote_number']; ?></td>
