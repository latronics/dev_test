...
class Adaptive_payments extends CI_Controller 
{
	...
	function Pay_chained()
	{
		...
		$ClientDetailsFields = array(
								'CustomerID' => '123', 								// Your ID for the sender  127 char max.
								'CustomerType' => '123', 								// Your ID of the type of customer.  127 char max.
		...
		$Receivers = array();
		$Receiver = array(
						'Amount' => '1000.00', 											// Required.  Amount to be paid to the receiver.
						'Email' => 'tcesarusa@gmail.com', 												// Receiver's email address. 127 char max.
						'InvoiceID' => '25', 											// The invoice number for the payment.  127 char max.
