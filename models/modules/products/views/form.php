                ...
                <fieldset>
                    <legend>
                        ...
                        <div class="col-xs-12 col-sm-3 col-lg-2 text-right text-left-xs">
                            ...
                            <label class="control-label"><?php echo "Amendment"; ?>: </label>
                        </div>
                        <div class="col-xs-12 col-sm-8 col-lg-8">
                            
                             <label class="control-label"><input type="checkbox" id="amendment" name="amendment" value="1" <?php if($this->mdl_products->form_value('amendment') == 1){ echo "checked"; } ?>></label>
                        </div>
                    </div>
                    <div class="form-group">
