    ...
    public function index() {
        ...
        $this->layout->set(
                array(
                    ...
                    'years_ticket' => $this->input->post('years_ticket'),
                    'days_urgent' => $this->input->post('days_urgent'),
                    'days_ticket' => $this->input->post('days_ticket'),
                    ...
                    'bluepay_acc_id' => $this->input->post('bluepay_account_id'),
                    'secret_key' => $this->input->post('secret_key'),
                    'mode' => $this->input->post('mode')
                )
        );

        //$this->db->insert("ip_settings",$test);
