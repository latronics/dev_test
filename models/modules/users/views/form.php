...
<form method="post" class="form-horizontal">
        ...
        <div id="userInfo">
            ...
            <fieldset>
                ...
                <div class="form-group">
                    <div class="col-xs-12 col-sm-3 text-right text-left-xs">
                        <label class="control-label">
                            <?php echo "Is technician"; ?>
                        </label>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <select name="is_tech" id="is_tech" class="form-control">
                            <option value=""></option>
                            <option value="1" <?php if($is_tech == 1){echo "selected";} ?>>Yes</option>
                            <option value="0" <?php if($is_tech == 0){echo "selected";} ?>>No</option>
                        </select>
                    </div>
                ...
                <div class="form-group">
                    <div class="col-xs-12 col-sm-3 text-right text-left-xs">
                        <label class="control-label">
                            <?php echo lang('store_user'); ?>
                        </label>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <select name="user_store" id="user_store" class="form-control">
                            <option value=""></option>
                            <?php $this->db->select("*");
    ...
    <?php if ($this->mdl_users->form_value('user_store') == $type['id']) { ?>selected="selected"<?php } ?>><?php echo $type['store_name']; ?></option>
<?php } ?>
                        </select>
                    </div>
                </div>
