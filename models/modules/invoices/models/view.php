...
<?php } ?>
                ...
                <div class="col-xs-12 col-md-7" style="width:1350px; float: right;">
...
<?php } ?>
                            ...
                            <div class="col-xs-12 col-sm-6">
                                ...
                                <div class="table " style="float:left; width: 607px; margin-left:15px; ">
                                    <div class="form-group" style="text-align:center;">
                                        <label class="control-label" ><?php echo "<b>" . lang('invoices_history') . "</b>"; ?></label>
                                    </div>

                                    <div class="form-group" style="height:300px; overflow: auto; border-radius: 4px;" >
